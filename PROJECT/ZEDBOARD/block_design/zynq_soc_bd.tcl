puts "Info:(ZQ) This block design file has been exported with Reference-Design Scripts from zynq Electronic GmbH for Board Part:em.avnet.com:zed:part0:1.4 with FPGA xc7z020clg484-1 at 2018-12-19T23:03:30."
...
CONFIG.c_use_s2mm_fsync {2} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins s_axis_s2mm_aclk] [get_bd_pins VDMA1/m_axi_mm2s_aclk] [get_bd_pins VDMA1/m_axi_s2mm_aclk] [get_bd_pins VDMA1/m_axis_mm2s_aclk] [get_bd_pins VDMA1/s_axis_s2mm_aclk]
...
CONFIG.NUM_SI {2} \
  ...
  connect_bd_intf_net -intf_net PS7_axi_periph_M05_AXI [get_bd_intf_pins PS7_axi_periph/M05_AXI] [get_bd_intf_pins Sine_0/ctrl_saxi]
...
proc create_hier_cell_PS { parentCell nameHier } {
  ...
  connect_bd_net -net TO_PS_FCLK_CLK3 [get_bd_pins FCLK_CLK3] [get_bd_pins TO_PS/FCLK_CLK3]
  ...
  connect_bd_net -net rst_PS7_150M_peripheral_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins TO_PS/M00_ARESETN]
...
proc create_hier_cell_D5M { parentCell nameHier } {
  ...
  # Create instance: videoProcess, and set properties
  set videoProcess [ create_bd_cell -type ip -vlnv xilinx.com:user:videoProcess:1.0 videoProcess ]
  set_property -dict [ list \
CONFIG.revision_number {0x10212018} \
 ] $videoProcess

  # Create interface connections
  connect_bd_intf_net -intf_net config_axis_1 [get_bd_intf_pins config_axis] [get_bd_intf_pins videoProcess/config_axis]
  connect_bd_intf_net -intf_net videoProcess_0_m_axis_mm2s [get_bd_intf_pins video_out] [get_bd_intf_pins videoProcess/m_axis_mm2s]
  connect_bd_intf_net -intf_net videoProcess_0_rgb_m_axis [get_bd_intf_pins videoProcess/rgb_m_axis] [get_bd_intf_pins videoProcess/rgb_s_axis]

  # Create port connections
  connect_bd_net -net CLK_75MHZ_1 [get_bd_pins CLK_75MHZ] [get_bd_pins videoProcess/config_axis_aclk]
  connect_bd_net -net idata_1 [get_bd_pins idata] [get_bd_pins videoProcess/idata]
  connect_bd_net -net ifval_1 [get_bd_pins ifval] [get_bd_pins videoProcess/ifval]
  connect_bd_net -net ilval_1 [get_bd_pins ilval] [get_bd_pins videoProcess/ilval]
  connect_bd_net -net peripheral_aresetn_1 [get_bd_pins peripheral_aresetn] [get_bd_pins videoProcess/config_axis_aresetn]
  connect_bd_net -net pixclk_1 [get_bd_pins pixclk] [get_bd_pins videoProcess/pixclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins CLK_150MHZ] [get_bd_pins videoProcess/m_axis_mm2s_aclk] [get_bd_pins videoProcess/rgb_m_axis_aclk] [get_bd_pins videoProcess/rgb_s_axis_aclk]
  connect_bd_net -net rst_PS7_150M_peripheral_aresetn [get_bd_pins aresetn] [get_bd_pins videoProcess/m_axis_mm2s_aresetn] [get_bd_pins videoProcess/rgb_m_axis_aresetn] [get_bd_pins videoProcess/rgb_s_axis_aresetn]
...
proc create_hier_cell_SYSTEM_RESETS { parentCell nameHier } {
  ...
  # Create instance: rst_PS7_25M, and set properties
  set rst_PS7_25M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_PS7_25M ]
  ...
  connect_bd_net -net PS_VIDEO_FCLK_RESET0_N [get_bd_pins ext_reset_in] [get_bd_pins rst_PS7_150M/ext_reset_in] [get_bd_pins rst_PS7_25M/ext_reset_in] [get_bd_pins rst_PS7_75M/ext_reset_in]
  ...
  connect_bd_net -net rst_PS7_25M_peripheral_aresetn [get_bd_pins peripheral_aresetn2] [get_bd_pins rst_PS7_25M/peripheral_aresetn]
  ...
  connect_bd_net -net slowest_sync_clk2_1 [get_bd_pins slowest_sync_clk2] [get_bd_pins rst_PS7_25M/slowest_sync_clk]
...
proc create_hier_cell_PS_VIDEO { parentCell nameHier } {
  ...
  connect_bd_net -net PS_FCLK_CLK3 [get_bd_pins FCLK_CLK3] [get_bd_pins PS/FCLK_CLK3]
  ...
  connect_bd_net -net rst_PS7_75M_peripheral_aresetn [get_bd_pins M01_ARESETN] [get_bd_pins D5M/peripheral_aresetn] [get_bd_pins PS/M01_ARESETN]

    ...
    while (menu_calls_enable == TRUE)
    {
        ...
        case vga:
            /*****************************************************************************************************************/
        	 point_Interest(10);
        	 deltaConfig(100);
        	 pvideo.time = D5M_mReadReg(D5M_BASE,REG30);
        	         if (pvideo.time !=  (0x0000ff & D5M_mReadReg(D5M_BASE,REG30)))
        	         {
        	        	 i++;
        	        	 point_Interest(i);
        	         }

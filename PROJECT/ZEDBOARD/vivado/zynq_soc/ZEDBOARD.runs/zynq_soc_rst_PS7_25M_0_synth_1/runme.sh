...
HD_PWD='V:/SOBELDETECT/DEBUG/RELEASED/ZEDBOARD/vivado/zynq_soc/ZEDBOARD.runs/zynq_soc_rst_PS7_25M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_soc_rst_PS7_25M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_soc_rst_PS7_25M_0.tcl

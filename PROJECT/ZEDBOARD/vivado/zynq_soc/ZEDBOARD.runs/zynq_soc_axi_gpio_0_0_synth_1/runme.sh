...
HD_PWD='V:/ZEDBOARD/vivado/zynq_soc/ZEDBOARD.runs/zynq_soc_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_soc_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_soc_axi_gpio_0_0.tcl
